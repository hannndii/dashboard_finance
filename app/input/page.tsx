          ...
          <div>
            ...
            <div className="flex items-center">
              <button
                ...
                className="w-10 h-10 bg-slate-100 rounded-l-lg border border-slate-200 text-slate-600 hover:bg-slate-200"
              >
                -
              </button>
              <input
              ...
              <button
                ...
                className="w-10 h-10 bg-slate-100 rounded-r-lg border border-slate-200 text-slate-600 hover:bg-slate-200"
              >
                +
              </button>
            </div>
        ...
        {paymentMethod === "QRIS" && (
          <div className="bg-blue-50/50 p-4 rounded-xl border border-blue-100 mb-4 animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <div className="flex flex-col items-center justify-center w-full">
              {/* TAMPILAN PREVIEW (MUNCUL JIKA ADA GAMBAR) */}
              {previewUrl && (
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-2xl shadow-2xl flex flex-col items-center max-w-[300px] w-full text-center animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-slate-500 text-sm">
              Data transaksi berhasil disimpan. Mengalihkan...
            </p>
          </div>
        </div>
      )}
