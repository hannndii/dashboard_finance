    ...
    <AppShell
      ...
      subtitle={
        <span className="text-[10px] font-medium text-slate-500 uppercase tracking-widest">
          Analisis dan riwayat periode fiskal
        </span>
      }
      rightElement={
      ...
      <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="rounded-[1.5rem] border border-slate-200 bg-white p-6 md:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <p className="text-[10px] uppercase tracking-widest font-bold text-slate-500">Total Pendapatan</p>
            </div>
          ...
          <div className="rounded-[1.5rem] border border-slate-200 bg-white p-6 md:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <p className="text-[10px] uppercase tracking-widest font-bold text-slate-500">Total Pengeluaran</p>
            </div>
            <h3 className="text-3xl font-bold text-slate-900 tracking-tight">
              Rp 12.450.000
            </h3>
          ...
          <div className="rounded-[1.5rem] bg-slate-900 p-6 md:p-8 text-white shadow-xl shadow-slate-900/20">
            <div className="flex items-center gap-3 mb-6">
              ...
              <p className="text-[10px] uppercase tracking-widest font-bold text-white/70">Laba Bersih</p>
            </div>
        ...
        <div className="rounded-[1.5rem] border border-slate-200 bg-white p-6 md:p-8">
          <div className="flex items-center justify-between mb-8">
             <div>
                <h3 className="text-slate-900 text-lg font-bold">Tren Pendapatan & Pengeluaran</h3>
                <p className="text-[10px] font-medium text-slate-500 uppercase tracking-widest mt-1">Visualisasi performa keuangan bulan ini</p>
             </div>
             <div className="flex items-center gap-4 text-xs font-bold text-slate-900">
                <div className="flex items-center gap-2"><span className="w-3 h-3 rounded-full bg-slate-900"></span> Pendapatan</div>
                <div className="flex items-center gap-2 text-slate-500"><span className="w-3 h-3 rounded-full bg-slate-200"></span> Pengeluaran</div>
             </div>
          </div>
            ...
            <table className="w-full min-w-[900px] table-auto text-left">
              <thead>
                <tr className="border-b border-slate-100 text-[10px] uppercase tracking-widest font-bold text-slate-500">
                  ...
                  <th className="pb-4">Referensi</th>
                  ...
                  transactions.map((trx: any) => (
                    ...
                    >
                      <td className="py-4 text-sm font-medium text-slate-900">
                        {new Date(trx.createdAt).toLocaleDateString("id-ID", { month: "short", day: "numeric", year: "numeric" })}
                      </td>
                      ...
                      <td className="py-4 text-sm font-medium text-slate-500">
                        {trx.paymentMethod === "QRIS" ? "Dompet Digital" : "Tunai"}
                      </td>
